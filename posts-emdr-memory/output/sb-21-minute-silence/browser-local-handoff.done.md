...
python3 scripts/fetch-topic-cover.py --topic sb-21-minute-silence
python3 scripts/publish-browser-deferred.py --topic sb-21-minute-silence --submit --finish --git-push
```
