...
python3 scripts/fetch-topic-cover.py --topic sb-14-morning-fog
python3 scripts/publish-browser-deferred.py --topic sb-14-morning-fog --submit --finish --git-push
```
