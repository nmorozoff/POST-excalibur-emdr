...
python3 scripts/fetch-topic-cover.py --topic sb-20-ask-for-support
python3 scripts/publish-browser-deferred.py --topic sb-20-ask-for-support --submit --finish --git-push
```
