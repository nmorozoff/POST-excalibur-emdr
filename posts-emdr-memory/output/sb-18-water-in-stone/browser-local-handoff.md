...
python3 scripts/fetch-topic-cover.py --topic sb-18-water-in-stone
python3 scripts/publish-browser-deferred.py --topic sb-18-water-in-stone --submit --finish --git-push
```
