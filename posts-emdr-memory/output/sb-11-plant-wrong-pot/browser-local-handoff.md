...
python3 scripts/fetch-topic-cover.py --topic sb-11-plant-wrong-pot
python3 scripts/publish-browser-deferred.py --topic sb-11-plant-wrong-pot --submit --finish --git-push
```
